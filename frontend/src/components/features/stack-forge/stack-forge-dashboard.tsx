...
export const StackForgeDashboard: React.FC<StackForgeDashboardProps> = () => {
  ...
  return (
    <div className={`flex flex-col items-center h-full w-full ${isDark ? "bg-slate-950 text-slate-100" : "bg-slate-50 text-slate-900"} p-8 overflow-y-auto pt-16 transition-colors duration-300`}>
      <div className="flex justify-end w-full max-w-2xl mb-4 gap-2">
        ...
        >
          {(i18n.resolvedLanguage || i18n.language || "ko-KR").startsWith("ko") ? "English" : "한국어"}
        </button>
        <button
          onClick={toggleTheme}
          className={`px-3 py-1 text-xs font-medium border ${isDark ? "border-slate-700 hover:bg-slate-800" : "border-slate-300 hover:bg-slate-200"} rounded-full transition-colors`}
      ...
      <div className={`max-w-2xl w-full my-auto space-y-8 ${isDark ? "bg-slate-900/50" : "bg-white"} p-10 rounded-2xl border ${isDark ? "border-slate-800" : "border-slate-200"} shadow-2xl backdrop-blur-sm mb-12`}>
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <label htmlFor="project-name" className={`block text-sm font-medium ${isDark ? "text-slate-300" : "text-slate-700"}`}>
          ...
          <div className="space-y-2">
            <label htmlFor="project-description" className={`block text-sm font-medium ${isDark ? "text-slate-300" : "text-slate-700"}`}>
            ...
            <textarea
              ...
              placeholder={t(I18nKey.STACKFORGE$PROJECT_DESCRIPTION_PLACEHOLDER)}
          ...
          <div className="space-y-2">
            <label htmlFor="supabase-token" className={`block text-sm font-medium ${isDark ? "text-slate-300" : "text-slate-700"}`}>
          ...
          <div className="space-y-2">
            <label htmlFor="cloudflare-token" className={`block text-sm font-medium ${isDark ? "text-slate-300" : "text-slate-700"}`}>
          ...
          <div className="space-y-2">
            <label htmlFor="polar-key" className={`block text-sm font-medium ${isDark ? "text-slate-300" : "text-slate-700"}`}>
          ...
          <div className="space-y-2">
            <label htmlFor="github-token" className={`block text-sm font-medium ${isDark ? "text-slate-300" : "text-slate-700"}`}>
          ...
          <div className={`pt-4 border-t ${isDark ? "border-slate-800" : "border-slate-200"}`}>
            <h3 className="text-lg font-semibold text-orange-400 mb-4">{t(I18nKey.STACKFORGE$GCP_SECTION_TITLE)}</h3>
            <div className="space-y-4">
              <div className="space-y-2">
                <label htmlFor="gcp-project-id" className={`block text-sm font-medium ${isDark ? "text-slate-300" : "text-slate-700"}`}>
              ...
              <div className="space-y-2">
                <label htmlFor="gcp-creds" className={`block text-sm font-medium ${isDark ? "text-slate-300" : "text-slate-700"}`}>
          ...
          >
            {isBuilding ? t(I18nKey.STACKFORGE$BUILD_BUTTON_WORKING) : t(I18nKey.STACKFORGE$BUILD_BUTTON_IDLE)}
          </button>
        </div>

...
export enum I18nKey {
  ...
  STACKFORGE$TITLE = "STACKFORGE$TITLE",
  STACKFORGE$SUBTITLE = "STACKFORGE$SUBTITLE",
  STACKFORGE$PROJECT_NAME_LABEL = "STACKFORGE$PROJECT_NAME_LABEL",
  STACKFORGE$PROJECT_DESCRIPTION_LABEL = "STACKFORGE$PROJECT_DESCRIPTION_LABEL",
  STACKFORGE$PROJECT_DESCRIPTION_PLACEHOLDER = "STACKFORGE$PROJECT_DESCRIPTION_PLACEHOLDER",
  STACKFORGE$SUPABASE_TOKEN_LABEL = "STACKFORGE$SUPABASE_TOKEN_LABEL",
  STACKFORGE$CLOUDFLARE_TOKEN_LABEL = "STACKFORGE$CLOUDFLARE_TOKEN_LABEL",
  STACKFORGE$POLAR_KEY_LABEL = "STACKFORGE$POLAR_KEY_LABEL",
  STACKFORGE$GITHUB_TOKEN_LABEL = "STACKFORGE$GITHUB_TOKEN_LABEL",
  STACKFORGE$GCP_SECTION_TITLE = "STACKFORGE$GCP_SECTION_TITLE",
  STACKFORGE$GCP_PROJECT_ID_LABEL = "STACKFORGE$GCP_PROJECT_ID_LABEL",
  STACKFORGE$GCP_CREDS_LABEL = "STACKFORGE$GCP_CREDS_LABEL",
  STACKFORGE$BUILD_BUTTON_IDLE = "STACKFORGE$BUILD_BUTTON_IDLE",
  STACKFORGE$BUILD_BUTTON_WORKING = "STACKFORGE$BUILD_BUTTON_WORKING",
  STACKFORGE$FOOTER_TEXT = "STACKFORGE$FOOTER_TEXT",
  STACKFORGE$BUILD_STARTED_ALERT = "STACKFORGE$BUILD_STARTED_ALERT",
}
